...
#include "volum_detect_viewer.h"

using namespace std;
using namespace cv;

class VolumDetectViewer0
{
public:
    ...
    VolumDetectViewer0():viewer("PCLVIEW")
    {
        // 1. 初始化 new viewer
    ...
    void run()
    {
        ...
        boost::function<void(const pcl::PointCloud<pcl::PointXYZ>::ConstPtr&)> f =
            boost::bind(&VolumDetectViewer0::cloud_cb_, this, _1, cloud, &new_cloud_available);
...
void VolumDetectViewer::compute_volum()
{
    VolumDetectViewer0 v;
    v.run();
}
