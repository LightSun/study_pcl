...
#include "study_3dobj_containment_box.h"

//./moment_of_inertia ./data/milk_color.pcd
void Study_3dobj_containment_box::test_moment_of_inertia()
{
    std::string inFile="";

    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud (new pcl::PointCloud<pcl::PointXYZ> ());
    if (pcl::io::loadPCDFile (inFile, *cloud) == -1)
        return;
